...
function ListCart() {
    ...
    return (
        <Box color="accent" p="4" alignItems={"center"} width={"700px"}>
        <Flex direction="column" gap="4">
            <Flex justify="space-between" align="center" marginInline="30px">
            <Text fontSize="2xl" color="secondary">Tu Carrito de Artesanías</Text>
            <IconButton
            ...
            <Button bg="secondary" onClick={ handleShowForm }>Direccion de envio</Button>
            </Group>
        </Flex>
